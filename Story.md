...
从构建这个项目的想法出现开始，<span style="color:#4790a0; ">我是想通过这个项目降低我的信心和勇气的势能消减速度</span>，然而我发现，经过这几年，我的心境早已发生了改变，对技术没有以前那样忠实了，也不再认为它能够为我的生活带来一些改变。思考过这个项目真的没有那个必要产生，市面上有很多应用程序做得很优秀，完全可以使用它们，如果单纯为了数据安全，为什么不用一个笔记本呢？这个项目值得继续下去的只有数据服务可以本地部署。Android的发展速度很快，也需要考虑到设备兼容性问题，这个问题最直接的体现在花费了很长的时间开发，却发现应用程序根本不能使用几年，以及手机厂商的定制化系统，进一步限制了应用程序的功能通用性，需要不断的维护它。<span style="color:#4790a0; ">对开发的时间成本和提供的价值考量，我认为这个项目不能再分配很多时间了，不管出于哪方面的思考，它可能变得不再那么重要了！</span>我需要去做更加重要的事了，一直以来，我将这件事弄错了优先级，事实上，它对我的生活并不重要，却把它放在了不该在的位置上！现在它结束了！（2024.05.01）
